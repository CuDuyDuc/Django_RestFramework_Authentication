...
class VerifyEmail(views.APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            return Response({'error': f'Activation Expired {indentifier}'}, status=status.HTTP_400_BAD_REQUEST)
        except jwt.exceptions.DecodeError as indentifie:
            return Response({'error': f'Invalid token {indentifie}'}, status=status.HTTP_400_BAD_REQUEST)
